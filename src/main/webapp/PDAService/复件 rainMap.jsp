...
<link href="styles/default/list.css" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript">
		...
		function displayMenu(){
		   ...
		   mesgMenu.style.pixelLeft = iX  ;
		   mesgMenu.style.pixelTop  = iY  ;
...
<script language="javascript">
	...
	function changePos(){
		mapTitle.style.pixelLeft = document.body.offsetWidth/2 - 250;
		//mapTitle.style.display = "";
		queryToolbar.style.pixelLeft = document.body.offsetWidth/2 + 120;
		queryToolbar.style.display = "";
		tuli.style.pixelLeft = document.body.offsetWidth/2 + 150;
		tuli.style.display = "";
		timeDiv.style.pixelLeft = document.body.offsetWidth/2 + 150;
		<%if(aMaxRain.size() > 0){
		...
		%>
				try{
					W<%=countyRainValue.getAddvcd()%>.style.pixelLeft =  (document.body.offsetWidth-396)/2 - 50 + parseFloat(mlist['<%=countyRainValue.getAddvcd()%>'].split(",")[0]);
					W<%=countyRainValue.getAddvcd()%>.style.pixelTop  = parseFloat(mlist['<%=countyRainValue.getAddvcd()%>'].split(",")[1]) - 4;
		...
		construction.style.pixelLeft = document.body.offsetWidth/2-360;
